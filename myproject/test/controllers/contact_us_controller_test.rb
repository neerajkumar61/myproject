...
class ContactUsControllerTest < ActionController::TestCase
  ...
  test "should create contact_u" do
    assert_difference('ContactU.count') do
      post :create, contact_u: { email: @contact_u.email, message: @contact_u.message, name: @contact_u.name, phone_no: @contact_u.phone_no }
    end
  ...
  test "should update contact_u" do
    patch :update, id: @contact_u, contact_u: { email: @contact_u.email, message: @contact_u.message, name: @contact_u.name, phone_no: @contact_u.phone_no }
    assert_redirected_to contact_u_path(assigns(:contact_u))
  end
